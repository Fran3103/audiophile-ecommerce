...
const Yx1Earphones = () => {
  return (
    <div className='flex flex-col  justify-center items-center gap-3 w-[327px]  md:w-[689px] lg:w-full lg:max-w-[1100px] m-auto md:flex-row mb-12'>
        ...
        <div className='w-full h-[200px] md:w-[339px] md:h-[320px] lg:w-[540px]    p-8 lg:pl-20 bg-[#74777D] rounded-lg flex flex-col justify-between md:justify-center md:gap-8'>
