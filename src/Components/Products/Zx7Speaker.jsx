...
import productDesktop from '../../assets/product-zx7-speaker/desktop/image-product.jpg'
import productTablet from '../../assets/product-zx7-speaker/tablet/image-product.jpg'
import productMobile from '../../assets/product-zx7-speaker/mobile/image-product.jpg'
...
import zx7Desktop from '../../assets/product-zx9-speaker/desktop/image-category-page-preview.jpg'
import zx7Tablet from '../../assets/product-zx9-speaker/tablet/image-category-page-preview.jpg'
import zx7Mobile from '../../assets/product-zx9-speaker/mobile/image-category-page-preview.jpg'
            ...
            <div className="px-6 mb-12 flex flex-col w-full mt-4">
                <div className="w-full md:flex gap-6 ">
                    ...
                    <div className="text-left flex flex-col justify-center items-start gap-4 mt-3 lg:items-start  ">
                        <h2 className="text-3xl uppercase font-bold md:text-5xl  lg:mx-0 lg:text-left">ZX7 SPEAKER</h2>
                        <p className="text-base  md:text-lg lg:text-left lg:mx-0 ">Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.</p>
                ...
                <div className="my-12 lg:flex w-full gap-12 lg:mb-24">
                    ...
                    <div className="flex flex-col justify-center items-start gap-4 mt-12 md:flex-row lg:flex-col  lg:justify-start lg:items-start lg:w-[40%] lg:mt-0">
                        ...
                        <div className="flex flex-col gap-2 ">
                            ...
                            <p><span className="text-orange font-bold mr-3">1x</span>7.5m Optical Cable</p>
